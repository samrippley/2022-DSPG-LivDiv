                                     ...
                                     fluidRow(style = "margin: 6px;", align = "justify",
                                              ...
                                              column(4, 
                                                     ...
                                                     p("Migration appears to be a prominent livelihood strategy – on average, approximately 65% of households had at least one migrant in the last ten years. 
                                                       ...
                                                       suggesting other possible economic opportunities in these three villages. Our data also indicated that saving by these households is very unfrequent, as most hosueholds reported no savings in the year this data was collected."),
                                                     br(),
                                                     p(strong("Select:")),
