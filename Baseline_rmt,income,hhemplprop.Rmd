---
title: "Baseline Remittance and Proportion of employed members in Household"
author: "Nandini Das"
date: '2022-06-15'
...
p<-ggplot(data=df2, aes(x=d, y=l,  width=0.7, fill=d)) +
  ...
  labs(y="Average household employment proportions", x="Villages", fill="white")+ggtitle("Mean proportion of household employed members per village in Baseline week") +
