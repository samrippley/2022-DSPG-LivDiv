...
- Money orders often have additional fees attached to them and using mobile apps can be difficult in places where data usage is very limited.
...
- It makes sense that a large majority of remittance is used on food, especially if the remittance is being received after devastaion (cyclone)
